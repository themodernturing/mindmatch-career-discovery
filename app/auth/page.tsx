...
export default function AuthPage() {
  ...
  // If already logged in, check for completed results before redirecting
  useEffect(() => {
    const check = async () => {
    ...
    <div className="min-h-screen bg-[#0a0a0f] flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="flex flex-col items-center mb-10">
          ...
          <h1 className="text-2xl font-black text-white tracking-tight">MindMatch</h1>
          <p className="text-slate-500 text-sm mt-1">Sign in to start your assessment</p>
        </div>
