...
// ARCHIVED — Google OAuth kept for future reference
...
//   })
// }
// <button onClick={handleGoogleLogin} className="w-full flex items-center justify-center gap-3 bg-white text-gray-800 font-semibold py-3.5 px-6 rounded-xl hover:bg-gray-50 transition-colors shadow-lg">
