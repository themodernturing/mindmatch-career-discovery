      ...
      <div className="max-w-[720px] mx-auto px-8 py-10 print:px-0 print:py-0">
        ...
        <div className="flex items-start justify-between mb-8 pb-6 border-b-2 border-slate-900">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="font-black text-slate-900 text-xl tracking-tight">MindMatch</p>
        ...
        <div className="mb-8">
          ...
          <p className="text-slate-500 text-sm">
            {educationLevel === 'university' ? 'University student' : 'School student'} · Assessment completed on MindMatch
          </p>
        </div>
        ...
        <div className="pt-4 border-t border-slate-200 flex items-center justify-between">
          <p className="text-xs text-slate-400">Generated by MindMatch · mind-match-assessment-at.netlify.app</p>
