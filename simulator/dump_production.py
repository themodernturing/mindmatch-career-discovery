...
personas_order = ['Sara','Ali','Hiba','Ahmed','Maryam','Ayesha','Bilal','Hamza','Daniyal','Tariq','Fatima']

for name in personas_order:
    ...
    mode = d['mode'].upper()
    ad_count = d['answers_count']['adaptive']
    onet_count = d['answers_count']['onet']
    print('=== {} ({}) - {} adaptive + {} onet ==='.format(name, mode, ad_count, onet_count))
